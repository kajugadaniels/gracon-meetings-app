/**
 * Static Zoom-style meeting room surface for design and workflow validation.
 */
'use client';
...
import styles from './static-meeting-room.module.css';

interface StaticMeetingRoomProps {
 ...
 */
export function StaticMeetingRoom({ meeting }: StaticMeetingRoomProps) {
